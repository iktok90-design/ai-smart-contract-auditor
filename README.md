...
/plugin install auditsentry@iktok90-design-ai-smart-contract-auditor
/auditsentry-init                           # 60-second setup
...
- [btcpay-scanner](https://github.com/iktok90-design/btcpay-scanner) — BTCPay Server network scanner & SSRF CVE auditor
- [bitcoin](https://github.com/iktok90-design/bitcoin) — Bitcoin Core (fork)
- [lnd](https://github.com/iktok90-design/lnd) — Lightning Network Daemon (fork)
